#2.3 Write a program to prompt the user for hours and rate per hour
...
# use input to read a string and float() to convert the string to a
# number. Do not worry about error checking or bad user data.

hours = input('Enter amount of hours: ')
rate = input('Enter hourly rate: ')
print('Pay: ' + str(hours.float() * rate.float()))
